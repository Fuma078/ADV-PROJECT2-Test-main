...
public class Constants {
    ...
    public static final double INVINCIBILITY_TIME = 1.5; // (เพิ่ม)
    ...
    public static final int BOSS_BULLET_DAMAGE = 1; // (ใช้สำหรับ Boss 2)
    ...
    public static final int SCORE_MINION_TIER2_KILL = 250; // (เพิ่ม)
    public static final int SCORE_CANNON_DESTROY = 500;
    public static final int SCORE_BOSS_DEFEAT = 10000; // (ใช้สำหรับ Boss 1 & 2)
    ...
    public static final String BACKGROUND = "/sprites/background.png"; // (ด่าน 1)
